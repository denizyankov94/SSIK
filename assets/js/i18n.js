...
(function () {
  ...
  const T = {
    bg: {
      ...
      "prj.ref.eyebrow": "Референции",
      "prj.ref.h2": "Реализирани обекти",
      "prj.ref.lead": "Част от завършените ни обекти през годините.",
      "prj.tag.renov": "Саниране",
      "prj.tag.public": "Обществена сграда",
      "prj.tag.resid": "Жилищна сграда",
      ...
      "about.lead": "\u201eСтроителство и саниране инженеринг консулт\u201c ЕООД (ССИК) е строителна компания, основана през 2006 г. Специализирани сме в жилищно строителство и еднофамилни къщи \u2014 с инженерен опит, модерни технологии и стриктен контрол на качеството.",
      "about.acr.eyebrow": "Какво означава ССИК",
      "about.acr.w1": "Строителство",
      "about.acr.w2": "Саниране",
      "about.acr.w3": "Инженеринг",
      "about.acr.w4": "Консулт",
      "about.mv.eyebrow": "Мисия и ценности",
      "about.mv.h2": "Качество, което се вижда след години",
      "about.mv.p": "Политиката ни е насочена към създаването на висококачествена строителна продукция с квалифициран екип, в атмосфера на творчество и отговорност. Не гоним най-ниската цена, а най-доброто съотношение между качество, срок и дълготрайност \u2014 всеки обект се изпълнява така, сякаш е за нас самите.",
    ...
    en: {
      ...
      "prj.ref.eyebrow": "References",
      "prj.ref.h2": "Completed projects",
      "prj.ref.lead": "A selection of the sites we\u2019ve completed over the years.",
      "prj.tag.renov": "Renovation",
      "prj.tag.public": "Public building",
      "prj.tag.resid": "Residential building",
      "prj.meta.year": "Year",
      "prj.meta.area": "Area",
      ...
      "about.lead": "\u201cStroitelstvo i sanirane inzhenering konsult\u201d Ltd (SSIK) is a construction company founded in 2006. We specialise in residential buildings and single-family houses \u2014 with engineering expertise, modern technology and strict quality control.",
      "about.acr.eyebrow": "What ССИК stands for",
      "about.acr.w1": "Construction",
      "about.acr.w2": "Renovation",
      "about.acr.w3": "Engineering",
      "about.acr.w4": "Consulting",
      "about.mv.eyebrow": "Mission & values",
      "about.mv.h2": "Quality that shows years later",
      "about.mv.p": "Our policy is focused on delivering high-quality construction with a qualified team, in an atmosphere of creativity and responsibility. We don't chase the lowest price, but the best balance of quality, timing and durability \u2014 every site is built as if it were our own.",
